...
const Home = () => {
    return ( 
        ...
        <p style={{
           ...
           Passionate about full-stack development, competitive programming, and constant growth.</p>
...
<div style={{
    ...
    gap:'40px',
     marginTop:'5%'
         ...
         }} className="aboutBtn">About Me</button>
...
<a href="https://github.com/tabrez-nitr" target="_blank" rel="noopener noreferrer" className="social-logo">
<svg xmlns="http://www.w3.org/2000/svg" 
  width="24" height="24" 
  fill="none" 
  stroke="#31D978" /* Change color here */ 
  strokeWidth="2" 
  strokeLinecap="round" 
...
<a href="https://www.linkedin.com/in/tabrez-sams-2410a7204/" target="_blank" rel="noopener noreferrer" className="social-logo">
<svg xmlns="http://www.w3.org/2000/svg" 
  width="24" height="24" 
  fill="none" 
  stroke="#31D978" /* Change color here */
...
<a href="https://x.com/tabrez__sams" target="_blank" rel="noopener noreferrer" className="social-logo">
<svg xmlns="http://www.w3.org/2000/svg" 
  width="24" height="24" 
  fill="none" 
  stroke="#31D978" /* Change color here */
...
<a href="https://www.instagram.com/tabrez__sams/" target="_blank" rel="noopener noreferrer" className="social-logo">
<svg xmlns="http://www.w3.org/2000/svg" 
  width="24" height="24" 
  fill="none" 
  stroke="#31D978" /* Change color here */
